...
**Dataset**: `antisocial.csv` (N = 405 children from the NLSY)
...
$$y_{it} = \gamma_{00} + \gamma_{01}\text{male}_i + (\gamma_{10} + \gamma_{11}\text{male}_i)\cdot\text{age}_{it} + u_{0i} + u_{1i}\text{age}_{it} + \varepsilon_{it}$$
...
**Dataset**: `selfconcept.dat` — 228 children, self-concept measured at ages 8, 10, and 12
**Indicators** (4 per wave):
